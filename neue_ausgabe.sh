...
########################################################################
# Autor: Melina Friedrich - Robert-Stolz-Str. 2c - 63179 Obertshausen  #
# Datum: 27.06.2022                                                    #
# Martrikelnummer: 1406409                                             #
########################################################################
...
## Beginn - urspruenglicher Ansatzpunkt aus der Version "bestfit.sh" - function insertBestFit() ##
#  Autor dieser Einleitung: Steffen Rottke !!!
    echo "Speicher:"
    unset speicherout
...
## Ende - urspruenglicher Ansatzpunkt aus der Version "bestfit.sh" - function insertBestFit() ##
...
# save_name: Die Menge der enthaltenen Partitionsnamen wird an die Variable partitions uebergeben,
# da diese moeglicherweise wiederholt im weiteren Verlauf genutzt werden koennte und die Programmierung übersichtlicher gestaltet.
...
# Der komplette entstandene String ist dem Array zugewiesen.
...
# zuruecksetzen auf Standardfarbausgabe  
...
echo "======================================================="
echo 
# Hier wird jetzt das Array farbe im Bildschirm ausgegeben und farbige Zeichenfolge ( + + + + + + + + ) abgebildet.
echo ${farbe[*]}
echo
# Ausgabe der Legende
...
echo " Anzahl Partitionen: $partitions"
echo
echo " Name   -   Groesse "
echo "---------------------------------------------------------------"
...
echo " groesster freier Bloeck im Adressraum         :" $groessterfreierBlock
